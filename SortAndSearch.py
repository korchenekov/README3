...
# Вывод программы:
# Отсортированный массив: [3, 7, 14, 21, 29, 33, 42, 55, 67, 78]
# 
# Элемент 29 найден на позиции: 4
# Элемент 7 найден на позиции: 1
# Элемент 100 не найден в массиве
...
# 
# 1. СОРТИРОВКА ВСТАВКАМИ
# До сортировки: [15, 8, 42, 4, 23, 16]
# После сортировки: [4, 8, 15, 16, 23, 42]
# 
# 2. БЫСТРАЯ СОРТИРОВКА
# До сортировки: [24, 15, 38, 2, 19, 41, 8]
# После сортировки: [2, 8, 15, 19, 24, 38, 41]
# 
# 3. БИНАРНЫЙ ПОИСК
# Отсортированный массив: [3, 7, 14, 21, 29, 33, 42, 55, 67, 78]
# Элемент 29 найден на позиции 4
# Элемент 55 найден на позиции 7
